package com.example.springbootsecuringoauth2.config;
...
public class RedisConfig {
    ...
    * @throws
     */
    @Bean
    //@ConditionalOnProperty(prefix = "redis", name = "cluster-open", havingValue = "true")
   ...
   /* @Bean
    ...
    @ConditionalOnProperty(prefix = "redis", name = "cluster-open", havingValue = "false")
    public JedisConnectionFactory JedisConnectionFactory(JedisPoolConfig jedisPoolConfig){
    	System.err.println("sington======================");
